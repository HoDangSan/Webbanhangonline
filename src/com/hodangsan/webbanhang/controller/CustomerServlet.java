...
import com.hodangsan.webbanhang.entity.Customer;
...
//                }
    ...
    private void createCustomer(HttpServletRequest request, HttpServletResponse response) throws SQLException {
        ...
        Customer newcustomer = new Customer(idcustomer, customerName, sex, phone, iduser);
        this.customer.create(newcustomer);
        RequestDispatcher dispatcher = request.getRequestDispatcher("customer/create.jsp");
    ...
    private void showEditForm(HttpServletRequest request, HttpServletResponse response) throws SQLException {
        ...
        Customer customerNew = this.customer.getcustomer(id);
    ...
    private void updateCustomer(HttpServletRequest request, HttpServletResponse response) throws SQLException, IOException {
        ...
        Customer customernew = new Customer(id,customerName,sex,phone,iduser);

        this.customer.edit(customernew);
    ...
    private void deleteCustomer(HttpServletRequest request, HttpServletResponse response) throws SQLException, IOException {
        int id = Integer.parseInt(request.getParameter("id"));
        Customer customerNew = this.customer.getcustomer(id);
        this.customer.delete(customerNew);
        response.sendRedirect("customers");
    }
}
